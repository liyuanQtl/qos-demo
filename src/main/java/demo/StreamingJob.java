...
//		env.enableCheckpointing(5000);
		...
		FlinkKafkaConsumer010<Flow> myConsumer = KafkaConnect.getKafkaConsumer("/kafka.properties");
//        env.setParallelism(1);
		DataStream<Flow> stream = env.addSource(myConsumer).setParallelism(1);
